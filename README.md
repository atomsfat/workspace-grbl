# com-chilipeppr-workspace-grbl-debug6
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-grbl-debug6 |
| Name                  | Workspace / grbl |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-grbl-debug6"], // the id you gave your workspace
      function(myWorkspaceGrblDebug6) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / grbl just got loaded.", myWorkspaceGrblDebug6);
        myWorkspaceGrblDebug6.init();
      }
    );
  }
);
